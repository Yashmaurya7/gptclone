...
export default function Search() {
			...
			if (res.status !== 200) {
				...
				if (contextText) {
					...
					setAnswer((currentAnswer) => [
						...currentAnswer,
						"Sorry there is no context related to this question. Please ask something about Yash",
					]);
				}
			}
		}
    ...
    You are a very enthusiastic YashAI representative who loves
    to help people! Given the following sections from the YashAI
  ...
  `;
	...
	return (
		<>
			...
			<Input
				ref={inputRef}
				placeholder="Ask Yash ai a question"
				className="p-5"
				onKeyDown={(e) => {
					if (e.key === "Enter") {
						handleSearch();
